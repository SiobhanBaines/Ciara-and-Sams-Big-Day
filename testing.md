...
Only a user who has either `staff` or `superuser` authority can add, update or delete a guest.
    *Upload File*
The Guest List option on the navigation bar gives acces to the [Guest List](images/user-stories/guest-list-maint.png) maintenance screen which has the ability to upload a [guest csv file](images/user-stories/non-image-documents/gift-list.csv) into to guest model. 
    *Search*
...
To view the individual guests a user can click on the `View` button which will take them to the [guest detail](images/user-stories/view-guest.png)page.

    *Update guest details*
A user needs to click the `Edit` button to [update/change a guest.](images/user-stories/edit-guest.png) The user will be informed they are editing a guest and which guest they are editing.

    *Delete guest* 
When a user [deletes](images/user-stories/delete-guest-message.png) a guest it will be removed from the model and they will be informed which guest they have deleted.
...
Only a user who has either `staff` or `superuser` authority can add, update or delete a menu item.
    *Upload File*
The Menu option on the navigation bar gives acces to the [Menu Item List](images/user-stories/menu-maint.png) maintenance screen which has the ability to upload a [guest csv file](images/user-stories/non-image-documents/menu.csv) into to guest model. 
    *Add new menu item*
From the menu maintenance screen, the user can add a menu item by clicking the `Add A Menu Item` button which will bring up the page to [add a menu item.](images/user-stories/add-menu.png)

    *Read/view menu details*
The whole menu can be viewed by clicking the `View` button which will take them to the [guest detail](images/user-stories/view-menu.png)page.

    *Update menu items*
A user needs to click the `Edit` button to [update/change a menu item.](images/user-stories/edit-menu.png) The user will be informed they are editing a menu item.

    *Delete a menu item* 
When a user [deletes](images/user-stories/delete-menu-message.png) a menu item it will be removed from the modeland they will be informed they have deleted a menu item.

[#5](https://github.com/SiobhanBaines/Ciara-and-Sams-Big-Day/issues/5)  **As a user I want to maintain a wedding guest list.**
...
To view the individual gifts a user can either click on the image or the `View` button which will take them to the [gift detail](images/user-stories/view-gift.png)page.

    *Update gift details*
A user needs to click the `Edit` button to [update/change a gift.](images/user-stories/edit-gift.png) The user will be informed they are editing a gift and which gift they are editing.
...
To view the schedule a user can use the `View` button which will take them to the [schedule detail](images/user-stories/schedule-view.png)page.

    *Update schedule details*
A user needs to click the `Edit` button to [update/change a schedule](images/user-stories/schedule-edit.png) The user will be informed they are editing a schedule and which schedule they are editing.
...
To edit a venue there is an `Edit` button at the bottom of the page. [update/change a venue.](images/user-stories/venue-edit.png) The user will be informed which venue they are [editing](images/user-stories/venue-edit-message.png) 

    *Delete a venue* 
When a user [deletes](images/user-stories/venue-delete.png) the venue will be removed from the modeland they will be informed which venue they have deleted.
...
This user story has become not applicable because the users log in credentials are created when the guest list is uploaded and group_id for the party will be detailed on the wedding invitation with url for the website and instructions to use the postcode where the invitation was sent to as their password. 
...
[#22](https://github.com/SiobhanBaines/Ciara-and-Sams-Big-Day/issues/22) **As a user I want provide menu selections for all members of my party.**
